...
const SongPerformanceNotes = ({ performance_notes, dispatch, song }) => {
            ...
            {editable ?
                <FormControl>
                    <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                        <TextField label="Notes" name="notes" defaultValue={`${performance_notes}`} onDoubleClick={handleEditable}
...
const mapStoreToProps = (reduxState) => {
    return {
        notes: reduxState.song.performance_notes,
        song: reduxState.song,
    };
};
export default connect(mapStoreToProps)(SongPerformanceNotes);
