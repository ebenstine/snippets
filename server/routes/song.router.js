...
router.post('/', rejectUnauthenticated, async (req, res) => {
    ...
    const { title, tuning, performance_notes, priority, lyrics, src, description } = req.body;
    ...
    try {
        ...
        const result = await client.query(firstQuery, [userId, title, tuning, performance_notes, priority, lyrics, src]);
